...
# DataLoader for IISc MPI Sintel database.
...
class DataLoader(DataLoaderParent):
    ...
    def load_training_data(self, index: int, random_crop: bool = True, random_flip: bool = True):
        video_name, seq_name, pred_frame_num = self.video_names[index]
        ...
        frame2_path = self.dataroot / f'all/PoseWarping/PoseWarping01/{video_name}/{seq_name}/{pw_dirname_f2}/' \
                                      f'warped_frames{self.resolution_suffix}/{frame1_num:04}.npy'
        mask2_path = self.dataroot / f'all/PoseWarping/PoseWarping01/{video_name}/{seq_name}/{pw_dirname_f2}/' \
                                     f'masks{self.resolution_suffix}/{frame1_num:04}.npy'
        depth2_path = self.dataroot / f'all/PoseWarping/PoseWarping01/{video_name}/{seq_name}/{pw_dirname_f2}/' \
                                      f'warped_depths{self.resolution_suffix}/{frame1_num:04}.npy'
        frame0_path = self.dataroot / f'all/PoseWarping/PoseWarping01/{video_name}/{seq_name}/{pw_dirname_f0}/' \
                                      f'warped_frames{self.resolution_suffix}/{frame1_num:04}.npy'
        mask0_path = self.dataroot / f'all/PoseWarping/PoseWarping01/{video_name}/{seq_name}/{pw_dirname_f0}/' \
                                     f'masks{self.resolution_suffix}/{frame1_num:04}.npy'
        depth0_path = self.dataroot / f'all/PoseWarping/PoseWarping01/{video_name}/{seq_name}/{pw_dirname_f0}/' \
                                      f'warped_depths{self.resolution_suffix}/{frame1_num:04}.npy'
        poi_mask1_path = self.dataroot / f'all/LOF_POI/{poi_dirname}/{video_name}/{seq_name}/' \
    ...
    def load_testing_data(self, video_name: str, seq_name: int, pred_frame_num: int, pw_dirname: str,
                          padding: tuple = None):
        psp = None
        flip = False

        frame1_num = pred_frame_num - 1
        frame1_path = self.dataroot / f'all/RenderedData/{video_name}/rgb{self.resolution_suffix}/{seq_name}/' \
                                      f'{frame1_num:04}.npy'
        depth1_path = self.dataroot / f'all/RenderedData/{video_name}/depth{self.resolution_suffix}/{frame1_num:04}.npy'
        frame2_path = self.dataroot / f'all/PoseWarping/PoseWarping01/{video_name}/{seq_name}/{pw_dirname}/' \
                                      f'warped_frames{self.resolution_suffix}/{frame1_num:04}.npy'
        mask2_path = self.dataroot / f'all/PoseWarping/PoseWarping01/{video_name}/{seq_name}/{pw_dirname}/' \
                                     f'masks{self.resolution_suffix}/{frame1_num:04}.npy'
        depth2_path = self.dataroot / f'all/PoseWarping/PoseWarping01/{video_name}/{seq_name}/{pw_dirname}/' \
                                      f'warped_depths{self.resolution_suffix}/{frame1_num:04}.npy'
    ...
    def load_test_data(self, video_name: str, seq_name: int, pred_frame_num: int):
        data_dict = self.load_testing_data(video_name, seq_name, pred_frame_num, pw_dirname='1step_backward',
                                           padding=(6, 0))
    ...
    def load_prediction_data(self, video_name: str, seq_name: int, pred_frame_num: int):
        data_dict = self.load_testing_data(video_name, seq_name, pred_frame_num, pw_dirname='2step_forward',
                                           padding=(6, 0))
    ...
    def load_generation_data(self, video_name: str, seq_name: int, frame1_num: int, pw_dirname):
        data_dict = self.load_testing_data(video_name, seq_name, pred_frame_num=frame1_num + 1, pw_dirname=pw_dirname,
                                           padding=(6, 0))
