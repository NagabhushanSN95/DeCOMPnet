...
# RMSE measure between cropped predicted frames and ground truth frames
...
def start_qa(pred_videos_dirpath: Path, database_dirpath: Path, frames_datapath: Path, pred_folder_name: str):
    ...
    avg_rmse, rmse_data = mse_computer.compute_avg_rmse(rmse_data, database_dirpath, pred_videos_dirpath, pred_folder_name)
